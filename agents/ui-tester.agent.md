...
4. Write the test
5. Run it and debug until green
...
- Navigate to URLs
- Click, fill, select elements
- Take screenshots
- Read page content
- Run custom Playwright code via `runPlaywrightCode`

Use these for exploratory testing or when debugging test failures.
