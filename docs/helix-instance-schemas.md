...
Generated by: `install-helix.ps1` for core `he-*` skill entries and `setup-workspace.ps1` for active workspace repo-local candidates.
...
| `skills[].id` | yes | string | `he-*` for Helix core IDs, `hr-*` for runtime/projected IDs |
