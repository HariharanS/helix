...
If implementation work has just completed, run `/build-graph` first. A stale graph produces misleading blast-radius output.
...
Produce the following block for the calling reviewer agent:
