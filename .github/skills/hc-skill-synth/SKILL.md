...
description: Scans codebase for repeating patterns, evaluates skill-worthiness, and produces candidate skill reports for the hc-maker skill to create
...
For each candidate marked "CREATE SKILL", the report provides enough context for the `hc-maker` skill to generate the actual SKILL.md file.
